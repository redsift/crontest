/**
 * Crontest Sift. Frontend controller entry point.
 */
...
export default class MyController extends SiftController {
  ...
  loadView(state) {
    console.log('crontest: loadView', state);
    ...
    switch (state.type) {
      ...
      default:
        console.error('crontest: unknown Sift type: ', state.type);
    }
  }

  // Event: storage update
  // onStorageUpdate(value) {
  //   console.log('crontest: onStorageUpdate: ', value);
  ...
  //     bucket: 'x'
  //   }).then((values) => {
  //     console.log('crontest: getX returned:', values);
  //     return {};
  //   });
  // }
